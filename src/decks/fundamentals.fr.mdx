...
Ceci démarre un serveur web en mode dev. Taper la lettre `o` et `entrée`. Ou lancez votre navigateur vers l'url suivant: http://localhost:5173
...
- Cela s'appelle _React Fast Refresh_ (ainsi que _Hot Reload_)
...
Cela génèere un nouveau dossier nommé "dist". C'est ce petit dossier qu'il faut distribuer sur un serveur web.
