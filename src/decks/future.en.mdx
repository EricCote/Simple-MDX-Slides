...
<Sandpack  vExperimental showStyles >
      ...
      <main>
        ...
        <section className='gallery-view'>
          <ViewTransition>
            <figure>
              <img src={`${cdnURL}/${photos[currentIndex].file}.jpg`} />
              <ViewTransition update='figure-caption'>
                <figcaption>
...
- Scenarios:
  - Save state for parts of the UI the user isn’t using
  - pre-render parts that a user is likely to use next

---

## Effects don’t mount with hidden Activity
